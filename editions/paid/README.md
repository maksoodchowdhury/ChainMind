# ChainMind Enterprise (Paid)

A containerized enterprise RAG (Retrieval-Augmented Generation) assistant for supply-chain decision support using Python, FastAPI, vector search, and LLMs.

This edition preserves the full platform surface, including enterprise control-plane APIs and autonomy endpoints.
